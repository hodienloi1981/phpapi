<h1 class="text-4xl font-semibold text-gray-700 mb-4">BANNER</h1>
    ...
    <table class="min-w-full bg-white shadow-md rounded">
        ...
        <tbody class="text-gray-600 text-sm font-light">
            <tr class="border-b border-gray-200 hover:bg-gray-100">
                ...
                <td class="p-3 border border-gray-200">
                    http://localhost/PHPAPI/api/banner/read.php
                </td>
            </tr>
            <tr class="border-b border-gray-200 hover:bg-gray-100">
                ...
                <td class="p-3 border border-gray-200">
                    http://localhost/PHPAPI/api/banner/read_one.php?id=1
                </td>
            </tr>
            <tr class="border-b border-gray-200 hover:bg-gray-100">
                ...
                <td class="p-3 border border-gray-200">
                    http://localhost/PHPAPI/api/banner/create.php
                </td>
            </tr>
            <tr class="border-b border-gray-200 hover:bg-gray-100">
                ...
                <td class="p-3 border border-gray-200">
                    http://localhost/PHPAPI/api/banner/update.php?id=1
                </td>
            </tr>
            <tr class="border-b border-gray-200 hover:bg-gray-100">
                ...
                <td class="p-3 border border-gray-200">
                    http://localhost/PHPAPI/api/banner/delete.php?id=1
                </td>
            </tr>
            <tr class="border-b border-gray-200 hover:bg-gray-100">
                ...
                <td class="p-3 border border-gray-200">
                    http://localhost/PHPAPI/api/banner/getList.php?position=slideshow&limit=10
                </td>
            </tr>
        </tbody>
    </table>
