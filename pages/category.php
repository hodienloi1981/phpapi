<h1 class="text-2xl font-semibold text-gray-700 mb-4">category</h1>
    ...
    <table class="min-w-full bg-white shadow-md rounded">
        ...
        <tbody class="text-gray-600 text-sm font-light">
            ...
            <tr class="border-b border-gray-200 hover:bg-gray-100">
                ...
                <td class="p-3 border border-gray-200">
                    http://localhost/PHPAPI/api/category/read_one.php?id=1
                </td>
            </tr>
            <tr class="border-b border-gray-200 hover:bg-gray-100">
                ...
                <td class="p-3 border border-gray-200">
                    http://localhost/PHPAPI/api/category/create.php
                </td>
            </tr>
            <tr class="border-b border-gray-200 hover:bg-gray-100">
                ...
                <td class="p-3 border border-gray-200">
                    http://localhost/PHPAPI/api/category/update.php?id=1
                </td>
            </tr>
            <tr class="border-b border-gray-200 hover:bg-gray-100">
                ...
                <td class="p-3 border border-gray-200">
                    http://localhost/PHPAPI/api/category/delete.php?id=1
                </td>
            </tr>
            <tr class="border-b border-gray-200 hover:bg-gray-100">
